...
?>
    <aside class="sidebar">
            ...
            <?php if (isset($_SESSION['cargo']) && $_SESSION['cargo'] === 'super_admin'): ?>
                <div class="nav-group <?=(in_array($current_page, ['gestao_alunos.php', 'gestao_cursos.php', 'gestao_professores.php'])) ? 'active' : ''; ?>">
                    ...
                    <div class="nav-submenu">
                        ...
                        <a class="nav-subitem <?=($current_page == 'gestao_redefinicoes.php') ? 'active' : ''; ?>" href="gestao_redefinicoes.php">
                            <i data-lucide="key"></i>
                            <span>Senhas</span>
                        </a>
                    </div>
        ...
        <div class="ai-assistant-container">
            <div class="ai-backdrop" id="aiBackdrop" onclick="toggleAIChat()"></div>
            <div class="ai-chat-window" id="aiChatWindow">
                <div class="ai-chat-header">
                    ...
                    <div style="display:flex; gap: 8px;">
                        <button onclick="expandAIChat()" style="background:none; border:none; color:#64748b; cursor:pointer;" title="Expandir">
